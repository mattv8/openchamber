...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.git.reviewLayoutTitle": "Diseño de revisión",
  "settings.openchamber.git.reviewLayoutAria": "Diseño de revisión",
  "settings.openchamber.git.reviewLayout.option.separate": "Vistas separadas",
  "settings.openchamber.git.reviewLayout.option.combined": "Git + cambios combinados",
  "settings.openchamber.git.reviewLayout.optionAria": "Diseño de revisión: {option}",
  ...
  "settings.openchamber.visual.field.animatedActivityIndicatorsInfo": "Las sesiones en ejecución muestran un indicador animado en lugar del punto estático. El indicador se actualiza 20 veces por segundo y consume más energía que el punto.",
