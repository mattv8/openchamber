...
export const settingsDict = {
  ...
  'settings.openchamber.git.reviewLayoutTitle': 'Układ przeglądu',
  'settings.openchamber.git.reviewLayoutAria': 'Układ przeglądu',
  'settings.openchamber.git.reviewLayout.option.separate': 'Oddzielne widoki',
  'settings.openchamber.git.reviewLayout.option.combined': 'Połączone Git i zmiany',
  'settings.openchamber.git.reviewLayout.optionAria': 'Układ przeglądu: {option}',
