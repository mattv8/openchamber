...
export const dict = {
  ...
  'gitView.history.actions.conflictToastDescription': 'Conflicts in: {files}. Resolve manually and commit, or use the Abort button in the operation banner.',
  'gitView.history.actions.conflictToastTitle': 'Conflict',
  'gitView.history.actions.unknownFiles': 'unknown files',
  'gitView.history.actions.confirmButton': 'Confirm',
  'gitView.history.actions.createBranch': 'Create branch here',
  'gitView.history.actions.createBranchEllipsis': 'Create Branch…',
  'gitView.history.actions.createBranchConfirm': 'Create',
  'gitView.history.actions.createBranchPlaceholder': 'Branch name',
  'gitView.history.actions.createTagConfirm': 'Create',
  'gitView.history.actions.createTagEllipsis': 'Create Tag…',
  'gitView.history.actions.createTagPlaceholder': 'Tag name',
  'gitView.history.actions.checkoutDetached': 'Checkout (Detached)',
  'gitView.history.actions.compareWithMergeBase': 'Compare with Merge Base',
  'gitView.history.actions.compareWithRef': 'Compare with…',
  'gitView.history.actions.compareWithRemote': 'Compare with Remote',
  'gitView.history.actions.comparingWith': 'Comparing with {name}',
  'gitView.history.actions.copyMessage': 'Copy Commit Message',
  'gitView.history.actions.clearComparison': 'Clear comparison',
  ...
  'gitView.history.actions.openChanges': 'Open Changes',
  ...
  'gitView.history.actions.resetHardDirtyTitle': 'Discard uncommitted changes?',
  'gitView.history.actions.resetHardDirtyDescription': 'The working tree has uncommitted changes. Hard reset will permanently discard them.',
  'gitView.history.actions.resetHardDirtyConfirmButton': 'Discard and reset',
  ...
  'gitView.graph.localBranches': 'Local branches',
  'gitView.graph.tags': 'Tags',
  'gitView.graph.manualSelection': 'Select refs to include in the graph.',
  'gitView.graph.incomingChanges': 'Incoming changes',
  'gitView.graph.outgoingChanges': 'Outgoing changes',
  'gitView.graph.outdated': 'Graph history is outdated. Refresh to update it.',
  'gitView.graph.mergeBaseLookupFailed': 'Could not compare incoming and outgoing changes for this graph.',
  'gitView.graph.mergeBaseLabel': 'merge base',
  'gitView.graph.resizeAria': 'Resize graph pane',
  'gitView.preview.overlayAnnouncement': 'Diff preview opened. Press Escape to close it.',
  'gitView.preview.resizeAria': 'Resize diff preview',
  'gitView.preview.submodulePointer': 'Submodule pointer',
  'gitView.preview.tooLargeDescription': 'This diff is {totalSize} and exceeds the {maxSize} preview limit.',
  ...
  'gitView.operation.cherryPickInProgress': 'Cherry-pick in progress',
  'gitView.operation.revertInProgress': 'Revert in progress',
  ...
  'gitView.toast.commitMessageCopied': 'Commit message copied',
  ...
  'gitView.toast.cherryPickCompleted': 'Cherry-pick completed',
  'gitView.toast.cherryPickAborted': 'Cherry-pick aborted',
  'gitView.toast.cherryPickConflictsDetected': 'Cherry-pick conflicts detected',
  'gitView.toast.revertCompleted': 'Revert completed',
  'gitView.toast.revertAborted': 'Revert aborted',
  'gitView.toast.revertConflictsDetected': 'Revert conflicts detected',
  ...
  'gitView.toast.tagCreated': 'Created tag {name}',
  ...
  'diffView.actions.backToChat': 'Back to chat',
