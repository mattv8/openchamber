...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.git.reviewLayoutTitle': '審查版面',
  'settings.openchamber.git.reviewLayoutAria': '審查版面',
  'settings.openchamber.git.reviewLayout.option.separate': '分離檢視',
  'settings.openchamber.git.reviewLayout.option.combined': '合併的 Git 與變更',
  'settings.openchamber.git.reviewLayout.optionAria': '審查版面：{option}',
