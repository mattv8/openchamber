...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.git.reviewLayoutTitle': '검토 레이아웃',
  'settings.openchamber.git.reviewLayoutAria': '검토 레이아웃',
  'settings.openchamber.git.reviewLayout.option.separate': '분리된 보기',
  'settings.openchamber.git.reviewLayout.option.combined': 'Git + 변경사항 결합',
  'settings.openchamber.git.reviewLayout.optionAria': '검토 레이아웃: {option}',
