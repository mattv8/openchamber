...
export const settingsDict = {
  ...
  'settings.openchamber.git.reviewLayoutTitle': 'Disposition de révision',
  'settings.openchamber.git.reviewLayoutAria': 'Disposition de révision',
  'settings.openchamber.git.reviewLayout.option.separate': 'Vues séparées',
  'settings.openchamber.git.reviewLayout.option.combined': 'Git + modifications combinés',
  'settings.openchamber.git.reviewLayout.optionAria': 'Disposition de révision : {option}',
