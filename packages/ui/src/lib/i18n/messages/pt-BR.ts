...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.history.actions.conflictToastDescription": "Conflitos em: {files}. Resolva manualmente e faça commit, ou use o botão Abortar no banner de operação.",
  "gitView.history.actions.conflictToastTitle": "Conflito",
  "gitView.history.actions.unknownFiles": "arquivos desconhecidos",
  ...
  "gitView.history.actions.resetHardDirtyTitle": "Descartar alterações não confirmadas?",
  "gitView.history.actions.resetHardDirtyDescription": "A árvore de trabalho tem alterações não confirmadas. O reset fixo as descartará permanentemente.",
  "gitView.history.actions.resetHardDirtyConfirmButton": "Descartar e resetar",
  ...
  "gitView.graph.localBranches": "Branches locais",
  "gitView.graph.tags": "Tags",
  "gitView.graph.manualSelection": "Selecione as referências que devem entrar no grafo.",
  "gitView.graph.incomingChanges": "Alterações de entrada",
  "gitView.graph.outgoingChanges": "Alterações de saída",
  "gitView.graph.outdated": "O histórico do grafo está desatualizado. Atualize para ver as mudanças.",
  "gitView.graph.mergeBaseLookupFailed": "Não foi possível comparar as mudanças de entrada e saída deste grafo.",
  "gitView.graph.resizeAria": "Redimensionar painel do grafo",
  "gitView.preview.overlayAnnouncement": "Pré-visualização do diff aberta. Pressione Escape para fechá-la.",
  "gitView.preview.resizeAria": "Redimensionar a pré-visualização do diff",
  "gitView.preview.submodulePointer": "Ponteiro do submódulo",
  "gitView.preview.tooLargeDescription": "Este diff tem {totalSize} e excede o limite de visualização de {maxSize}.",
  ...
  "gitView.operation.mergingMessage": "Fazendo merge: {message}",
   ...
   "gitView.operation.cherryPickInProgress": "Cherry-pick em andamento",
   "gitView.operation.revertInProgress": "Revert em andamento",
  ...
  "gitView.toast.cherryPickCompleted": "Cherry-pick concluído",
  "gitView.toast.cherryPickAborted": "Cherry-pick cancelado",
  "gitView.toast.cherryPickConflictsDetected": "Conflitos de cherry-pick detectados",
  "gitView.toast.revertCompleted": "Revert concluído",
  "gitView.toast.revertAborted": "Revert cancelado",
  "gitView.toast.revertConflictsDetected": "Conflitos de revert detectados",
  ...
  "diffView.state.fileUnchangedInScope": "Este arquivo não tem alterações no escopo selecionado.",
  ...
  'diffView.actions.backToChat': 'Voltar ao chat',
  ...
  'gitView.history.actions.createBranchEllipsis': 'Criar branch…',
  'gitView.history.actions.createTagConfirm': 'Criar',
  'gitView.history.actions.createTagEllipsis': 'Criar tag…',
  'gitView.history.actions.createTagPlaceholder': 'Nome do tag',
  'gitView.history.actions.checkoutDetached': 'Checkout (detached)',
  'gitView.history.actions.compareWithMergeBase': 'Comparar com base de merge',
  'gitView.history.actions.compareWithRef': 'Comparar com…',
  'gitView.history.actions.compareWithRemote': 'Comparar com remoto',
  'gitView.history.actions.comparingWith': 'Comparando com {name}',
  'gitView.history.actions.copyMessage': 'Copiar mensagem do commit',
  'gitView.history.actions.clearComparison': 'Limpar comparação',
  'gitView.history.actions.openChanges': 'Abrir alterações',
  'gitView.toast.commitMessageCopied': 'Mensagem do commit copiada',
  'gitView.toast.tagCreated': 'Tag {name} criado',
  'gitView.graph.mergeBaseLabel': 'base de merge',
};
