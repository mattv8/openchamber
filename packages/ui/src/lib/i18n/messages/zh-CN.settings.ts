...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.git.reviewLayoutTitle': '审查布局',
  'settings.openchamber.git.reviewLayoutAria': '审查布局',
  'settings.openchamber.git.reviewLayout.option.separate': '分离视图',
  'settings.openchamber.git.reviewLayout.option.combined': '合并的 Git 与更改',
  'settings.openchamber.git.reviewLayout.optionAria': '审查布局：{option}',
