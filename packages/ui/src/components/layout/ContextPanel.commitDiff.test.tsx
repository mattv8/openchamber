...
mock.module('./GuestRailIcon', () => ({ GuestIcon: () => null }));
...
mock.module('@/hooks/useGuestSurfaces', () => ({ useGuestSurfaces: () => [] }));
...
mock.module('@/stores/useUIStore', () => ({
  clampContextEditorTreeWidth: (width: number) => width,
...
mock.module('@/lib/runtime-auth', () => ({
  getLocalRuntimeUrlAuthTokenSync: () => null,
  getRuntimeBearerTokenSync: () => null,
  getRuntimeExtraHeadersSync: () => ({}),
  getRuntimeUrlAuthTokenSync: () => null,
}));
...
mock.module('@/lib/editorFocus', () => ({ isVimEditorEventTarget: () => false }));
mock.module('@/lib/guests/icon', () => ({ FALLBACK_GUEST_ICON: 'window' }));
mock.module('@/lib/guests/store', () => ({
  useGuestsStore: Object.assign(() => null, { getState: () => ({ guests: [] }) }),
}));
mock.module('@/lib/surfaces/modes', () => ({
  isPluginContextPanelMode: () => false,
  pluginIdFromMode: () => '',
}));
